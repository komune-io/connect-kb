...
from tool_cccev import CccevParser, CccevParserTool, CccevVerifierTool
...
def init_graph():
    ...
    for node in nodes:
        ...
        """, {"embedded_text": node_embedded_text, "embedding": node_embedding, "id": node_id})
        ...
        for relationship in relationships:
            ...
            r_embedded_text = relationship_to_text(r_type, r_source["identifier"], r_target.get("identifier", r_target["name"]))
...
def cccev_extract(input_file_path: str, resultCount: int):
...
Output Directory: {DIR_OUTPUT}
    ...
    # cccev_extract(f"{DIR_INPUT}/{FILE_VM003}", 26)
    ...
    # Text: This 3-year project does not use fire as part of its forest management.
    # """
    # question = """What information concepts have been extracted from the document VM0003-IFM-Through-Extension-Of-Rotation-Age-v1.3.pdf?"""
    question = "What requirements apply to Forest Management Practices?"
